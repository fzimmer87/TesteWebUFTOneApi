    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            binding_setter1 = new StringFormaterDecorator(binding_setter1,"{Step.DataFetchActivity6.OutTable}");
            bind_dir1 = new BindDirection(_flow.DataFetchActivity6,binding_getter1,binding_setter1,BindTargetType.ToInProperty);
            _flow.DataExporterActivity8.InDirections.Add(bind_dir1);
            ...
            binding_setter2 = new StringFormaterDecorator(binding_setter2,"{Step.DataFetchActivity6.OutTable}");
            bind_dir2 = new BindDirection(_flow.DataFetchActivity6,binding_getter2,binding_setter2,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity7.InDirections.Add(bind_dir2);
            ...
            binding_setter3 = new StringFormaterDecorator(binding_setter3,"{Step.DataFetchActivity6.OutTable}");
            bind_dir3 = new BindDirection(_flow.DataFetchActivity6,binding_getter3,binding_setter3,BindTargetType.ToInProperty);
            this.DataCursorActivity10.InDirections.Add(bind_dir3);
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            VTDPropertyInfoBase pi7 = new VTDPropertyInfoBase("username");
            VTDBaseGetter binding_getter4 = new VTDObjectGetter(pi7);
            VTDPropertyInfoBase pi8 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='Object'][1]/*[local-name(.)='username'][1]");
            VTDBaseSetter binding_setter4 = new VTDJsonSetter(pi8,XmlTypeCode.String);
            binding_setter4 = new StringFormaterDecorator(binding_setter4,"{DataSource.Registro.username}");
            bind_dir4 = new BindDirection(this.DataCursorActivity10,binding_getter4,binding_setter4,BindTargetType.ToInProperty);
            _flow.HTTPActivity4.InDirections.Add(bind_dir4);
            VTDPropertyInfoBase pi9 = new VTDPropertyInfoBase("password");
            VTDBaseGetter binding_getter5 = new VTDObjectGetter(pi9);
            VTDPropertyInfoBase pi10 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='Object'][1]/*[local-name(.)='password'][1]");
            VTDBaseSetter binding_setter5 = new VTDJsonSetter(pi10,XmlTypeCode.String);
            binding_setter5 = new StringFormaterDecorator(binding_setter5,"{DataSource.Registro.password}");
            bind_dir5 = new BindDirection(this.DataCursorActivity10,binding_getter5,binding_setter5,BindTargetType.ToInProperty);
            _flow.HTTPActivity4.InDirections.Add(bind_dir5);
            VTDPropertyInfoBase pi11 = new VTDPropertyInfoBase("lastname");
            VTDBaseGetter binding_getter6 = new VTDObjectGetter(pi11);
            VTDPropertyInfoBase pi12 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='Object'][1]/*[local-name(.)='lastname'][1]");
            VTDBaseSetter binding_setter6 = new VTDJsonSetter(pi12,XmlTypeCode.String);
            binding_setter6 = new StringFormaterDecorator(binding_setter6,"{DataSource.Registro.lastname}");
            bind_dir6 = new BindDirection(this.DataCursorActivity10,binding_getter6,binding_setter6,BindTargetType.ToInProperty);
            _flow.HTTPActivity4.InDirections.Add(bind_dir6);
            VTDPropertyInfoBase pi13 = new VTDPropertyInfoBase("firstname");
            VTDBaseGetter binding_getter7 = new VTDObjectGetter(pi13);
            VTDPropertyInfoBase pi14 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='Object'][1]/*[local-name(.)='firstname'][1]");
            VTDBaseSetter binding_setter7 = new VTDJsonSetter(pi14,XmlTypeCode.String);
            binding_setter7 = new StringFormaterDecorator(binding_setter7,"{DataSource.Registro.firstname}");
            bind_dir7 = new BindDirection(this.DataCursorActivity10,binding_getter7,binding_setter7,BindTargetType.ToInProperty);
            _flow.HTTPActivity4.InDirections.Add(bind_dir7);
